...
const Login = ({setLoggedin}) =>{
    ...
    return(
        ...
        <div onClick={()=>setLoggedin(false)} className="fixed top-0 bottom-0 left-0 right-0 z-100 bg-black/50 flex items-center justify-center">
        <form onSubmit={handler} onClick={(e)=>e.stopPropagation()} className="flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] text-gray-500 rounded-lg shadow-xl border border-gray-200 bg-white max-sm:mx-1">

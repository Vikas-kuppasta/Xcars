...
function Banner() {
    return (
        ...
        <div className='flex justify-between  items-center gap-40 rounded-xl bg-gradient-to-r from-blue-700 via-blue-400 to-blue-300 px-12 py-12'>
            ...
            <div>
                <img className='h-50' src={assets.banner_car_image} alt="" />
            </div>
        </div>
        </main>
    )
